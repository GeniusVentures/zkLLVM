...
if (ZK_BUILD_CLANG_TOOLS)
    list(APPEND _ZKLLVM_EXTRA_PARAM "-DCLANG_BUILD_TOOLS:BOOL=ON")
else()
    list(APPEND _ZKLLVM_EXTRA_PARAM "-DCLANG_BUILD_TOOLS:BOOL=OFF")
endif()

if (ZK_BUILD_LLVM_TOOLS)
    list(APPEND _ZKLLVM_EXTRA_PARAM "-DLLVM_BUILD_TOOLS:BOOL=ON")
else()
    list(APPEND _ZKLLVM_EXTRA_PARAM "-DLLVM_BUILD_TOOLS:BOOL=OFF")
endif()
