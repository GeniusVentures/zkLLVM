...
include(${CMAKE_CURRENT_LIST_DIR}/PlatformConfiguration.cmake)

set(CMAKE_C_STANDARD "17" CACHE STRING "CMAKE C standard")


if(CMAKE_BUILD_TYPE STREQUAL "Debug" OR ANDROID OR IOS)
    list(APPEND _ZKLLVM_EXTRA_PARAM "-DZKLLVM_BUILD_STD_LIB:BOOL=OFF")
elseif(APPLE OR WIN32 OR UNIX)
    list(APPEND _ZKLLVM_EXTRA_PARAM "-DZKLLVM_BUILD_STD_LIB:BOOL=ON")
endif()
